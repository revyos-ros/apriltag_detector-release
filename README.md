...
The packages in the `apriltag_detector` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble apriltag_detector --override-release-repository-push-url git@github.com:revyos-ros/apriltag_detector-release.git --edit` on `Tue, 17 Jun 2025 04:15:34 -0000`
...
- release repository: https://github.com/revyos-ros/apriltag_detector-release.git
...
## apriltag_detector (humble) - 2.1.0-6

The packages in the `apriltag_detector` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble apriltag_detector --override-release-repository-push-url git@github.com:revyos-ros/apriltag_detector-release.git` on `Tue, 17 Jun 2025 04:11:36 -0000`
...
## apriltag_detector (humble) - 2.1.0-5

The packages in the `apriltag_detector` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble apriltag_detector --override-release-repository-push-url git@github.com:revyos-ros/apriltag_detector-release.git` on `Fri, 13 Jun 2025 06:29:47 -0000`
...
## apriltag_detector (humble) - 2.1.0-4

The packages in the `apriltag_detector` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble apriltag_detector --override-release-repository-push-url git@github.com:revyos-ros/apriltag_detector-release.git` on `Mon, 11 Nov 2024 02:24:24 -0000`
...
## apriltag_detector (humble) - 2.1.0-3

The packages in the `apriltag_detector` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble apriltag_detector` on `Wed, 29 May 2024 05:28:20 -0000`
...
The packages in the `apriltag_detector` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv/bin/bloom-release -r humble apriltag_detector` on `Tue, 28 May 2024 08:49:17 -0000`
